...
import type { FirstActorMode, Format } from '@/types/veto';
  ...
  const createRoom = async () => {
    ...
    if (tab === 'presets') {
      ...
      config = {
        ...
        firstActorMode: preset.firstActorMode,
        steps: preset.steps,
          ...
          <div className="mx-auto max-w-2xl px-6 py-16">
            ...
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto mt-4 max-w-md text-sm text-muted-foreground">
                Choose a preset and share links with both teams. Results are
                saved locally and can be exported later.
              </p>
            </div>
                          ...
                          <div className="overflow-hidden">
                            <div className="grid grid-cols-4 gap-2 px-4 pb-4">
                              {group.stages.map((stage) => {
                                const active =
                                  selectedPresetId === stage.presetId;
                                return (
                                  <button
                                    key={stage.presetId}
                                    type="button"
                ...
                <TabsContent value="custom" className="space-y-4">
                  ...
                  <div className="rounded-lg border border-border bg-card p-4 space-y-1.5">
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      Want to customize the pick/ban order (e.g., bans first,
                      picks first), first-actor method (random coin flip,
                      coin-flip winner choice, or Team A first), or enforce
                      countdown timers?
                    </p>
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      You can easily define your own sequence using static JSON
                      files with custom step flows. Check out the{' '}
                      <a
                        href="https://github.com/sunguraa/StrinoBans#presets"
                        target="_blank"
                      ...
                      in the docs for format instructions.
                    </p>
                  </div>
                </TabsContent>
              </Tabs>
